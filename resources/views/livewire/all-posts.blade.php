<div>
    <!-- Modal Delete-->
    <div wire:ignore.self class="modal fade" id="deletePostModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="" wire:click.prevent='deletePost({{$post->id}})' data-bs-toggle="modal" data-bs-target="#deletePostModal" class="card-btn">Delete</a>
                    </div>
                </div>
            </div>
        @empty
