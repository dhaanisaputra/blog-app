<footer class="bg-dark mt-5">
    <div class="container section">
        <div class="row">
            <div class="col-lg-10 mx-auto text-center">
                <a class="d-inline-block mb-4 pb-2" href="/ykfb">
                <img loading="prelaod" decoding="async" class="img-fluid" src="{{ url('/back/dist/img/logo-favicon/'.blogInfo()->blog_logo) }}" alt="{{ blogInfo()->blog_name }}" style="max-width: 100px">
                </a>
    ...
    <div class="copyright bg-dark content">&copy; <script>document.write(new Date().getFullYear())</script> | Designed &amp; Developed By <a href="/ykfb">{{blogInfo()->blog_name}}</a></div>
</footer>
