            ...
            <div class="col-12 mb-4">
                ...
                <article class="card article-card">
                    ...
                    <div class="card-image">
                        ...
                        <img loading="lazy" decoding="async" src="{{ asset('back/dist/img/posts-upload/'.single_latest_post()->featured_image) }}" alt="Post Thumbnail" class="w-100">
                    </div>
                    </a>
                    ...
                    <article class="card article-card article-card-sm h-100">
                        <a href="{{route('read_post', $item->post_slug)}}">
                            <div class="card-image">
                                ...
                                <img loading="lazy" decoding="async" src="{{ asset('back/dist/img/posts-upload/'.$item->featured_image) }}" alt="Post Thumbnail" class="w-100">
                            </div>
                        </a>
                        ...
                        <div class="widget-body">
                            <div class="widget-list">
                                ...
                                <a class="media align-items-center" href="{{route('read_post', $item->post_slug)}}">
                                    <img loading="lazy" decoding="async" src="{{ asset('back/dist/img/posts-upload/thumbnails/thumb_'.$item->featured_image) }}" alt="Post Thumbnail" class="w-100">
